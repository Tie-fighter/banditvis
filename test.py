...
style1 = mapnik.Style()
rule1 = mapnik.Rule()
#rule1.symbols.append(mapnik.ShieldSymbolizer('NAME','DejaVu Sans Bold', 10, mapnik.Color('#000000'),'attacker.png', 'png', 5, 5))
...
layer1.datasource = mapnik.Shapefile(file='data/shapes/TM_WORLD_BORDERS-0.3')
